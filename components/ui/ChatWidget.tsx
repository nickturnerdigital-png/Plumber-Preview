  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 print:hidden">
      <AnimatePresence>
        {showPrompt && !open && (
          <motion.button
            ...
            className="absolute bottom-20 right-0 w-64 rounded-2xl bg-white p-4 text-left shadow-2xl ring-1 ring-navy-100"
          >
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="absolute bottom-20 right-0 flex h-[480px] w-[360px] max-w-[calc(100vw-2rem)] flex-col overflow-hidden rounded-3xl bg-white shadow-2xl ring-1 ring-navy-100"
          >
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.95 }}
        className="relative flex h-14 w-14 items-center justify-center rounded-full bg-electric-gradient text-white shadow-glow-blue"
